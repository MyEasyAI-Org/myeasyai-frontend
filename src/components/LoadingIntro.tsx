    ...
    <div className="min-h-screen bg-gradient-to-br from-black-main to-blue-main flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center space-y-8">
        ...
        <div className={`relative transition-all duration-1000 ease-out delay-300 ${
          ...
          {/* Main text */}
          <h1 className={`relative bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-6xl font-bold text-transparent transition-all duration-700 ${
        ...
        <div className={`transition-all duration-1000 ease-out delay-700 ${
          ...
          <p className={`text-slate-300 text-lg font-medium tracking-wide transition-all duration-500 ${
        ...
        {/* Loading dots */}
        <div className={`flex space-x-2 transition-all duration-1000 ease-out delay-1000 ${
          showText 
            ? 'opacity-100 translate-y-0' 
            : 'opacity-0 translate-y-3'
        }`}>
        ...
        {/* Progress indicator */}
        <div className={`w-64 h-1 bg-slate-700/50 rounded-full overflow-hidden transition-all duration-1000 ease-out delay-1200 ${
          showText 
            ? 'opacity-100 translate-y-0' 
            : 'opacity-0 translate-y-3'
        }`}>
