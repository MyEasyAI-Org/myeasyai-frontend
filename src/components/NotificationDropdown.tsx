...
export default function NotificationDropdown({
  ...
  return (
<<<<<<< HEAD
    <div className="absolute right-0 top-[52px] w-80 origin-top-right animate-in fade-in slide-in-from-top-2 duration-200 rounded-xl border border-slate-700 bg-slate-800/90 backdrop-blur-xl shadow-2xl shadow-black/50">
=======
...
>>>>>>> 74a70f764c0e4733cb57660094b9afc01c3dd4eb
      {/* Header */}
