...
export default function NotificationDropdown({
  ...
  return (
    <div className="absolute right-0 top-[52px] z-50 w-80 origin-top-right animate-in fade-in slide-in-from-top-2 duration-200 rounded-xl border border-slate-700 bg-slate-800/99 backdrop-blur-xl shadow-2xl shadow-black/50">
      {/* Header */}
