 ...
 *
 * Displays current study streak with fire animation and motivational messages.
 */

import { memo, useMemo } from 'react';
import { Flame, Calendar, Trophy, AlertTriangle, BookOpen } from 'lucide-react';
...
export const StudyStreakCard = memo(function StudyStreakCard({
  currentStreak,
  longestStreak,
  isActiveToday,
  totalStudyDays,
        ...
        <div className="flex-1 min-w-0">
          ...
          {!isActiveToday && currentStreak > 0 && (
            <div className="flex items-center gap-1 text-yellow-500 text-xs">
              ...
              <span>Estude hoje para manter!</span>
            </div>
          )}
        </div>
        {isActiveToday && (
      ...
      <div className="p-4 bg-gradient-to-r from-orange-500/10 to-amber-500/10 border-b border-slate-700/50">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white">Sequencia de Estudos</h3>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex items-center gap-3 p-3 bg-slate-700/30 rounded-lg">
            ...
            <div>
              <p className="text-xs text-slate-400">Total estudado</p>
              <p className="text-lg font-semibold text-white">
