  ...
  return (
    <div className="bg-white min-h-full relative">
      ...
      <div className="site-template">
        {/* Header */}
        <header
          className={`site-template-header ${headerBg} backdrop-blur-lg`}
          role="banner"
        >
          <div className="container mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <a
              href={
                siteData.phone
                  ? `https://wa.me/${siteData.phone.replace(/\D/g, '')}`
                  : '#contato'
              }
            ...
            >
              <span
                className={`block w-6 h-0.5 mb-1 transition-all duration-300 ${vibe === 'light' || vibe === 'elegant' ? 'bg-gray-900' : 'bg-white'}`}
              ...
              ></span>
              <span
                className={`block w-6 h-0.5 transition-all duration-300 ${vibe === 'light' || vibe === 'elegant' ? 'bg-gray-900' : 'bg-white'}`}
                style={{ transformOrigin: '4px 0px' }}
              ></span>
            </button>
          </div>
        ...
        {siteData.sections.includes('hero') && (
          ...
          >
            ...
            <div className="absolute inset-0 overflow-hidden z-0 pointer-events-none">
              ...
              <div
                className="absolute top-20 left-20 w-6 h-6 rounded-full bg-white opacity-60 hero-float-element"
                style={{ animationDelay: '0.5s' }}
              ></div>
              <div
                className="absolute top-40 right-32 w-5 h-5 rounded-full bg-white opacity-50 hero-pulse"
                style={{ animationDelay: '1.5s' }}
              ></div>
              <div
                className="absolute bottom-32 left-40 w-8 h-8 rounded-full bg-white opacity-40 hero-float-slow"
                style={{ animationDelay: '2.5s' }}
              ></div>
              <div
                className="absolute top-60 left-1/4 w-4 h-4 rounded-full bg-white opacity-70 hero-pulse"
                style={{ animationDelay: '3.5s' }}
              ></div>
              <div
                className="absolute bottom-40 right-1/4 w-5 h-5 rounded-full bg-white opacity-55 hero-float-element"
                style={{ animationDelay: '4s' }}
              ></div>
              <div
                className="absolute top-1/3 right-20 w-6 h-6 rounded-full bg-white opacity-45 hero-float-slow"
                style={{ animationDelay: '2s' }}
              ></div>

              {/* NOVAS partículas adicionais */}
              <div
                className="absolute top-10 right-1/4 w-7 h-7 rounded-full bg-white opacity-65 hero-pulse"
                style={{ animationDelay: '0.8s' }}
              ></div>
              <div
                className="absolute bottom-20 left-1/3 w-5 h-5 rounded-full bg-white opacity-60 hero-float-element"
                style={{ animationDelay: '1.2s' }}
              ></div>
              <div
                className="absolute top-1/2 left-10 w-6 h-6 rounded-full bg-white opacity-50 hero-float-slow"
                style={{ animationDelay: '3s' }}
              ></div>
              <div
                className="absolute bottom-60 right-40 w-4 h-4 rounded-full bg-white opacity-70 hero-pulse"
                style={{ animationDelay: '4.5s' }}
              ></div>
              <div
                className="absolute top-80 right-10 w-8 h-8 rounded-full bg-white opacity-45 hero-float-element"
                style={{ animationDelay: '0.3s' }}
              ></div>
              <div
                className="absolute bottom-10 left-20 w-6 h-6 rounded-full bg-white opacity-55 hero-float-slow"
                style={{ animationDelay: '5s' }}
              ></div>
              <div
                className="absolute top-1/4 left-1/2 w-5 h-5 rounded-full bg-white opacity-60 hero-pulse"
                style={{ animationDelay: '1.8s' }}
              ></div>
              <div
                className="absolute bottom-1/3 right-1/3 w-7 h-7 rounded-full bg-white opacity-50 hero-float-element"
                style={{ animationDelay: '3.2s' }}
              ></div>
              <div
                className="absolute top-96 left-60 w-4 h-4 rounded-full bg-white opacity-65 hero-float-slow"
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
              <div className="max-w-5xl mx-auto">
                ...
                <div
                  className="hero-slide-up flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-12 sm:mb-16 lg:mb-20 px-4"
                ...
                <div
                  className="hero-slide-up grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 px-4"
                  style={{ animationDelay: '0.5s' }}
                >
                  {(
                    siteData.heroStats || [
                    ...
                    >
                      ...
                      <p
                        className="text-xs sm:text-sm uppercase tracking-wider font-semibold opacity-90"
                        style={{ color: getContrastText(primaryColor) }}
                      >
                        {stat.label}
                      </p>
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="text-5xl font-black text-gray-900">
                Benefícios{' '}
                <span style={{ color: primaryColor }}>Exclusivos</span>
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  icon: 'M20 5L25 15H35L27.5 22.5L30 32.5L20 26.25L10 32.5L12.5 22.5L5 15H15L20 5Z',
                  title: 'Experiência Premium',
                  desc: 'Muito mais que um serviço, uma verdadeira experiência de luxo e conforto',
                },
                {
                  icon: 'M20 20m-15 0a15 15 0 1 0 30 0a15 15 0 1 0 -30 0M13 20L18 25L27 16',
                  title: 'Profissionais Qualificados',
                  desc: 'Equipe altamente treinada e experiente no que faz',
                },
                {
                  icon: 'M20 20m-15 0a15 15 0 1 0 30 0a15 15 0 1 0 -30 0M20 15V20L25 25',
                  title: 'Atendimento Fácil',
                  desc: 'Agende com total praticidade e rapidez',
                },
              ].map((feature, idx) => (
                <div
                  key={idx}
                ...
                >
                  ...
                  <div
                    className="mt-6 flex items-center justify-center gap-2 text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity"
        ...
        {siteData.sections.includes('about') && (
          <section
            ...
            style={{
              background: `linear-gradient(135deg, ${lightenColor(primaryColor, 0.95)}, ${lightenColor(accentColor, 0.97)})`,
            }}
          >
            {/* Fundo decorativo */}
            ...
            <div className="container mx-auto px-6 relative z-10">
              <div className="grid md:grid-cols-2 gap-20 items-center">
                ...
                <div className="relative h-[600px]">
                  ...
                  <div
                    className="about-rating-card absolute bottom-5 left-5 bg-white p-6 rounded-2xl shadow-2xl flex items-center gap-4 z-20 cursor-pointer border-2 border-transparent hover:border-opacity-50"
                ...
                <div className="about-content">
                  ...
                  <h2 className="text-5xl md:text-6xl font-black mb-6 leading-tight text-gray-900">
                    Do Sonho à<br />
                    <span style={{ color: primaryColor }}>Realidade</span>
                  </h2>

                  <p className="text-xl font-medium text-gray-700 mb-5 leading-relaxed">
                    Nossa empresa foi projetada para ser um ponto de referência
                    em qualidade, inovação e excelência.
                  </p>
            ...
            >
              ...
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-0 left-0 w-full h-full opacity-10">
                  <div
                    className="absolute top-20 left-20 w-64 h-64 rounded-full hero-pulse"
                    style={{
                      background:
                  ...
                  ></div>
                  <div
                    className="absolute bottom-20 right-20 w-80 h-80 rounded-full hero-float-slow"
                    style={{
                      background:
                  ...
                  ></div>
                  <div
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full hero-pulse"
                    style={{
                      background:
              ...
              <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center max-w-2xl mx-auto mb-16">
                  ...
                  >
                    Serviços que
                    <br />
                    <span style={{ textShadow: '0 6px 30px rgba(0,0,0,0.6)' }}>
                      Transformam
                    </span>
                  </h2>
                  <p
              ...
              <div className="grid md:grid-cols-2 gap-20 items-center">
                <div>
                  ...
                  >
                    Agende pelo
                    <br />
                    <span style={{ textShadow: '0 4px 8px rgba(0,0,0,0.6)' }}>
                      Aplicativo
                    </span>
                  </h2>
                  <p
                  ...
                  >
                    Baixe nosso app e tenha acesso a horários disponíveis,
                  ...
                  <div className="flex gap-5 flex-wrap">
                    <button
                      className="px-8 py-3 bg-white rounded-full font-semibold hover:scale-105 transition"
                      style={{ color: primaryColor }}
                    >
                      📱 Google Play
                    </button>
                ...
                <div className="relative text-center">
                  ...
                  <img
                    src="https://via.placeholder.com/300x600/1a1a1a/ffffff?text=App+Preview"
                    alt="App"
                    className="relative z-10 max-w-xs mx-auto drop-shadow-2xl rounded-3xl"
                  />
                </div>
              </div>
            </div>
        ...
        {siteData.sections.includes('faq') &&
          ...
          siteData.faq.length > 0 && (
            <section
              className="py-24"
              style={{
                background: `linear-gradient(to bottom, ${lightenColor(secondaryColor, 0.98)}, #ffffff)`,
              }}
            >
              <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                  ...
                  <h2 className="text-5xl font-black text-gray-900">
                    Perguntas{' '}
                    <span style={{ color: primaryColor }}>Frequentes</span>
                  </h2>
                </div>
          ...
          <section className="py-24 bg-gray-50">
            <div className="container mx-auto px-6">
              <div className="text-center mb-16">
                ...
                <h2 className="text-5xl font-black text-gray-900">
                  Planos que{' '}
                  <span style={{ color: primaryColor }}>Cabem no Bolso</span>
                </h2>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
                {[
        ...
        {siteData.sections.includes('team') && (
          <section
            className="py-24"
            style={{
              background: `linear-gradient(135deg, ${lightenColor(accentColor, 0.95)}, ${lightenColor(primaryColor, 0.97)})`,
            }}
          >
            <div className="container mx-auto px-6">
              <div className="text-center mb-16">
                ...
                <h2 className="text-5xl font-black text-gray-900">
                  Conheça nosso{' '}
                  <span style={{ color: primaryColor }}>Time</span>
                </h2>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
                {[
              ...
              <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-16">
                  ...
                  <p className="text-xl text-gray-600 mt-4 max-w-2xl mx-auto">
                    Confira alguns dos nossos melhores projetos e trabalhos
                    realizados
                  </p>
                </div>
        ...
        {siteData.sections.includes('testimonials') && (
          <section
            className="py-24 relative overflow-hidden"
            style={{
              background: `linear-gradient(to bottom right, #ffffff, ${lightenColor(primaryColor, 0.96)})`,
            }}
          >
            {/* Fundo decorativo */}
            ...
            <div className="container mx-auto px-6 relative z-10">
              ...
              <div className="text-center mb-16">
                ...
                <h2 className="text-5xl md:text-6xl font-black text-gray-900">
                  O que dizem
                  <br />
                  <span style={{ color: primaryColor }}>Nossos Clientes</span>
                </h2>
                <p className="text-xl text-gray-600 mt-4 max-w-2xl mx-auto">
                  Veja o que nossos clientes satisfeitos têm a dizer sobre
                  nossos serviços
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  ...
                  >
                    ...
                    <div
                      className="testimonial-stars mb-6"
                      style={{ color: '#fbbf24' }}
                    >
              ...
              <div className="text-center mt-16">
                <p className="text-lg text-gray-600 mb-6">
                  Você também é nosso cliente? Deixe seu depoimento!
                </p>
                <button
                  className="px-10 py-4 rounded-full font-bold uppercase text-sm tracking-wide shadow-xl hover:shadow-2xl transition-all transform hover:scale-105"
                  style={{
            ...
            <div className="container mx-auto px-6 relative z-10">
              ...
              <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="contact-info">
                  ...
                  {siteData.phone && (
                    <div
                      className="contact-item flex gap-5 mb-8 p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition cursor-pointer"
                      style={{ animationDelay: '0.1s' }}
                    >
                      <div
                        className="contact-icon w-14 h-14 flex-shrink-0 flex items-center justify-center rounded-xl"
                  ...
                  {siteData.email && (
                    <div
                      className="contact-item flex gap-5 mb-10 p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition cursor-pointer"
            ...
            <div className="grid md:grid-cols-3 gap-16 mb-10">
              <div>
                ...
                <p className="mb-6 leading-relaxed">
                  Experiência premium desde 2024
                </p>
              </div>
              <div>
